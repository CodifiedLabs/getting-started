...
👉 Accept Invitation to Spec-to-Code Rules Pro
...
Bash
git clone [https://github.com/CodifiedLabs/spec-to-code-pro.git](https://github.com/CodifiedLabs/spec-to-code-pro.git)
